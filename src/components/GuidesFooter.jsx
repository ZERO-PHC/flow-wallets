...
export default function GuidesFooter({ next, previous, title }) {
  return (
    <Flex justifyContent="space-between" p="50px 0" maxW={"1100px"} w="100%" gap={20}>
      <Flex gap={4} alignItems="center">
        <Button onClick={previous} variant="guideBtn"><Icon icon="eva:arrow-ios-back-outline" width="30" /></Button>
        <Text fontFamily="Blinker Bold" fontSize={{sm: "14px", lg: "25px"}}>Go Back</Text>
      </Flex>
      <Flex gap={4} alignItems="center">
        <Text fontFamily="Blinker Bold" fontSize={{sm: "14px", lg: "25px"}}>{title}</Text>
